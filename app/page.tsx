...
const copy = {
  ...
  ko: {
    ...
    evidenceTitle: '이용 가능한 근거', image: '이미지 근거', imageDesc: 'AM/PM × 좌/우 시야를 분리 보존', environment: '환경 + 구동기', environmentDesc: '시간 정렬 맥락', root: '근권', rootDesc: '함수율 · EC · 배지온도', growth: '생육 관측', growthDesc: '화방·과실·영양생장 측정값', harvest: '수확 + 품질', harvestDesc: '후속 결과 변수로만 사용',
    systemNote: '이 프로토타입은 데이터 모달리티, 검토 결정, 저장 결과를 분리 보존함. 다음 단계에서 2222 CMAA 실행기와 변경 불가능한 근거 이력을 연결함',

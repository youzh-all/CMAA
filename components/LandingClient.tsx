...
export function LandingClient() {
  ...
  return <main className="landing">
    ...
    <section className="landing-hero"><div className="hero-copy"><p>{t.eyebrow}</p><h1>{t.title}</h1><p className="hero-lead">{t.lead}</p><div className="hero-actions"><Link href="/workspace" className="primary-cta">{t.primary} <b>→</b></Link><a href="#workflow" className="secondary-cta">{t.secondary}</a></div><div className="trust-row"><span>● {t.trustA}</span><span>● {t.trustB}</span><span>● {t.trustC}</span></div></div>
      <aside className="landing-case"><p>{t.panelEyebrow}</p><h2>{t.panelTitle}</h2><div className="landing-preview"><div className="preview-top"><b>11 DEC 2025</b><span>GREENHOUSE 2</span></div><div className="preview-grid"><i></i><i></i><i></i><i></i></div><div className="preview-data"><span>Inside temperature <b>13.6 °C</b></span><span>Inside RH <b>74.6%</b></span><span>Substrate water <b>40.3%</b></span></div></div><small>{t.panelNote}</small></aside>
    </section>
